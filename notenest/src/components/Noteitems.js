  ...
  return (
    <>
      <div id="notes-container">
          ...
          <i className="fa-solid fa-trash mx-2" onClick={()=>{deleteNote(note._id);  props.showAlert("Note Deleted Successfully!", "success");}} style={{fontSize: "1rem", marginLeft: "1rem", color: "red", width:"2rem", cursor:"pointer"}}></i>
